...
void CreateLevelModel::AddTape(Tape const& p_tape) {
  ...
  m_tapesItem->appendRow(QList<QStandardItem*>() << tapeItem << new QStandardItem << new QStandardItem << new QStandardItem);
...
void CreateLevelModel::AddMirror(Mirror const& p_mirror) {
  ...
  m_mirrorsItem->appendRow(QList<QStandardItem*>() << mirrorItem << new QStandardItem << new QStandardItem << new QStandardItem);
...
void CreateLevelModel::AddOneWay(OneWay const& p_oneWay) {
  ...
  m_oneWaysItem->appendRow(QList<QStandardItem*>() << oneWayItem << new QStandardItem << new QStandardItem << new QStandardItem);
...
void CreateLevelModel::AddPortal(Portal const& p_portal) {
  ...
  m_portalsItem->appendRow(QList<QStandardItem*>() << portalItem << new QStandardItem << new QStandardItem << new QStandardItem);
